...
function BudgetItem({budget}) {
  ...
  return (
    <Link href={'/dashboard/expenses/' + budget.id} className='p-5 border rounded-lg hover:shadow-md cursor-pointer hover:shadow-indigo-300 hover:border-1 transition-all duration-400 '>
